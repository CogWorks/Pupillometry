...
rdaTetrisLog2(sid=subject.id, f=filename,  screen.res.height = 1080, screen.res.width = 1920, meta2=T)
...
g = rda[game_number > 0, gazetools(smi_samp_x_l, smi_samp_y_l, 150, 1920, 1080, 342.9, 193.675, smi_eye_z_l,ex = smi_eye_x_l, ey= smi_eye_y_l, blinks=(smi_samp_x_l==0 & smi_samp_y_l==0), timestamp=smi_ts)]
